angular.module('WonLead', []).controller('WonLeadController', function($scope,$rootScope,$window,$http,LeadService,CityService,$timeout,$routeParams,$route,$location,ClientService,CacheService,OrderService,InspectionService,SweetAlert,$filter,serverConfig,bitly,SMSService,AuthService,ManpowerService) {
    ...
    $scope.saveLeadData = function(){
      ...
      if($scope.leadData.spoc == '' || $scope.leadData.spoc == undefined || $scope.leadData.spoc == null) {
