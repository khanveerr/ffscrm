angular.module('ChangePassword', []).controller('ChangePasswordController', function($scope,$rootScope,$window,CityService,$timeout,$routeParams,$route,$location,CacheService,SweetAlert,$filter,AuthService) {
	...
	$scope.changePassword = function() {
		...
		if($scope.old_password == '' ) {
			...
			SweetAlert.swal("Error!", 'Please enter your old password', "error");
			return;

		} else if($scope.new_password == '') {

			SweetAlert.swal("Error!", 'Please enter your new password', "error");
			return;
			...
			AuthService.changePassword(data).then(function(response){
				...
				SweetAlert.swal("Success!", 'Password changed successfully.', "success");
				$route.reload();

			}, function(error){

				SweetAlert.swal("Error!", error.data.message.message, "error");
