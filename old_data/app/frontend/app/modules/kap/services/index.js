angular.module('KAPServiceHelper', []).factory('KAPService', ['$http','serverConfig', 'AuthService', function($http,serverConfig,AuthService) {
    ...
    return {
        ...
        saveKAP : function(kapData) {
            //return $http.post('http://localhost:3000/client/addNewClient', clientData);
            return $http({
                method: 'POST',
                url: 'http://engine.silagroup.co.in/api/public/kap/save',
                data: $.param({kapData}),
                headers: {'Content-Type': 'application/x-www-form-urlencoded'}
            });
        ...
        updateKAP : function(kapData) {
            //return $http.post('http://localhost:3000/client/addNewClient', clientData);
            return $http({
                method: 'POST',
                url: 'http://engine.silagroup.co.in/api/public/kap/update',
                data: $.param({kapData}),
                headers: {'Content-Type': 'application/x-www-form-urlencoded'}
            });
        ...
        saveActivity : function(kapData) {
            //return $http.post('http://localhost:3000/client/addNewClient', clientData);
            return $http({
                method: 'POST',
                url: 'http://engine.silagroup.co.in/api/public/activity/save',
                data: $.param({kapData}),
                headers: {'Content-Type': 'application/x-www-form-urlencoded'}
            });
        ...
        getAllKaps: function(data) {
            //return $http.post('http://localhost:3000/client/addNewClient', clientData);
            return $http({
                method: 'GET',
                url: 'http://engine.silagroup.co.in/api/public/get_kaps',
                params: data,
                headers: {'Content-Type': 'application/x-www-form-urlencoded'}
            });
        ...
        getKaps: function(data) {
            ...
            return $http({
                method: 'GET',
                url: 'http://engine.silagroup.co.in/api/public/get_all_kaps',
                params: data,
                headers: {'Content-Type': 'application/x-www-form-urlencoded'}
            });
        ...
        getAllCompanies: function(data) {
            ...
            return $http({
                method: 'GET',
                url: 'http://engine.silagroup.co.in/api/public/get_companies',
                params: data,
                headers: {'Content-Type': 'application/x-www-form-urlencoded'}
            });
