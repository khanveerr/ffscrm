angular.module('LostLead', []).controller('LostLeadController', function($scope,$rootScope,$window,$http,LeadService,CityService,$timeout,$routeParams,$route,$location,ClientService,CacheService,OrderService,InspectionService,SweetAlert,$filter,serverConfig,bitly,SMSService,AuthService,ManpowerService) {
    ...
    // LeadService.getServices().then(function(response){
    ...
    // LeadService.getLeadstages().then(function(response){
    //   //console.log(response.data);
    //   if(response.data != undefined && response.data != null) {
    ...
    // LeadService.getLeadsources().then(function(response){
    //   //console.log(response.data);
    //   if(response.data != undefined && response.data != null) {
    ...
    // LeadService.getCities().then(function(response){
    //   //console.log(response.data);
    //   if(response.data != undefined && response.data != null) {
    ...
    // LeadService.getVariants().then(function(response){
    //   //console.log(response.data);
    //   if(response.data != undefined && response.data != null) {
    ...
    // LeadService.getCategories().then(function(response){
    //   //console.log(response.data);
    //   if(response.data != undefined && response.data != null) {
    ...
    // LeadService.getClientFromLaravel().then(function(response){
    ...
    $scope.edit_lead = function(id) {
      ...
      LeadService.getLeadDetail(id).then(function(response){
        ...
        angular.element('#add_lead').openModal();
...
$scope.searchLeads = function(page) {
  ...
  if($scope.reason_filter != undefined && $scope.reason_filter != null && $scope.reason_filter != "") {
    $scope.search_data.reason = $scope.reason_filter;
  }
