angular.module('WonLead', []).controller('WonLeadController', function($scope,$rootScope,$window,$http,LeadService,CityService,$timeout,$routeParams,$route,$location,ClientService,CacheService,OrderService,InspectionService,SweetAlert,$filter,serverConfig,bitly,SMSService,AuthService,ManpowerService,KAPService) {
    ...
    $scope.contract_count = 0;
    $scope.total_contract_value = 0;
    $scope.bdm_contribution_total = 0;
    $scope.agp_value_total = 0;
    $scope.agp_bdm_value_total = 0;
    ...
    $scope.edit_won_lead = function(id) {
      ...
      LeadService.getLeadDetail(id).then(function(response){
        ...
        $scope.leadData.company_name = data.company_name;
        $scope.leadData.c3_won_value = data.c3_won_value;
        $scope.leadData.bdm_value = data.bdm_value;
        $scope.leadData.contract_renewal_date = data.contract_renewal_date;
        $scope.leadData.service_start_date = data.service_start_date;
        $scope.leadData.work_order_date = data.work_order_date;
        // $scope.leadData.won_month = data.won_month;
        // $scope.leadData.won_year = data.won_year;
        // $scope.leadData.closure_month = data.closure_month;
        // $scope.leadData.closure_year = data.closure_year;

        $scope.leadData.agp_percentage_value = data.agp_percentage_value;
        //$scope.leadData.agp_bdm_percentage_value = data.agp_bdm_percentage_value;
    ...
    $scope.show_won_lead_info = function(id) {
      ...
      LeadService.getLeadDetail(id).then(function(response){
        ...
        var data = response.data.result;
        $scope.leadInfoData.company_name = data.company_name;
        $scope.leadInfoData.c3_won_value = data.c3_won_value;
        $scope.leadInfoData.bdm_value = data.bdm_value;
        $scope.leadInfoData.contract_renewal_date_str = data.contract_renewal_date_str;
        $scope.leadInfoData.service_start_date_str = data.service_start_date_str;
        $scope.leadInfoData.work_order_date_str = data.work_order_date_str;

        $scope.leadInfoData.agp_percentage_value = data.agp_percentage_value;

        angular.element('#show_won_lead_info').openModal();
    ...
    $scope.saveWonLeadData = function() {
      ...
      //data.contract_renew_date = $scope.leadData.contract_renewal_date;
    ...
    $scope.updateReminder = function() {
      ...
      data.contract_renewal_date = (new Date($scope.reminder)).toISOString();

      LeadService.setContractReminder(data).then(function(response){
...
LeadService.getAllLeads($scope.search_data).then(function(response){
  ...
  $scope.contract_count = response.data.contract_count;
  $scope.bdm_contribution_total = response.data.bdm_contribution_total;
  $scope.agp_value_total = response.data.agp_value_total;
  $scope.agp_bdm_value_total = response.data.agp_bdm_value_total;
  $scope.total_contract_value = response.data.total_contract_value;
...
$scope.searchLeads = function(page) {
  ...
  if($scope.month_filter != undefined && $scope.month_filter != null && $scope.month_filter != "") {
    $scope.search_data.won_month = $scope.month_filter;
  }
