  ...
  function (
    ...
    $scope.save_lead = function () {
      ...
      if (
        ...
        $scope.leadData.c2_value != 0 &&
        $scope.leadData.c2_value != "0.0"
      ) {
        if (
      ...
      $scope.leadForm.status = 0;

      if($scope.leadData.c0_value == undefined || $scope.leadData.c0_value == null || $scope.leadData.c0_value == '') {
        $scope.leadData.c0_value = 0;
      }

      if($scope.leadData.c1_value == undefined || $scope.leadData.c1_value == null || $scope.leadData.c1_value == '') {
        $scope.leadData.c1_value = 0;
      }

      if($scope.leadData.c2_value == undefined || $scope.leadData.c2_value == null || $scope.leadData.c2_value == '') {
        $scope.leadData.c2_value = 0;
      }

      if($scope.leadData.c3_value == undefined || $scope.leadData.c3_value == null || $scope.leadData.c3_value == '') {
        $scope.leadData.c3_value = 0;
      }
    ...
    $scope.showImportantFirst = function() {
      $scope.show_important = $scope.show_important == false ? true : false;
    };
    ...
    function getLeads(page) {
      ...
      if($scope.show_important == true) {
        $scope.search_data.show_important_first = 1;
      }
    ...
    $scope.edit_lead = function (id) {
      ...
      LeadFactory.getLeadDetail(id).then(
        function (response) {
          ...
          // angular.element("#add_lead").modal("show");
        },
        function (error) {
          //alert(error.message);
          toastr.error(null, error.message);
    ...
    $scope.save_won_lead = function () {
      ...
      LeadFactory.createLead(update_data).then(function (res) {
        ...
        data.status = 1;
        if($scope.leadUpData.is_site_activated && ($scope.leadUpData.is_site_activated == 1 || $scope.leadUpData.is_site_activated == '1')) {
          data.is_site_activated = $scope.leadUpData.is_site_activated;
        }
